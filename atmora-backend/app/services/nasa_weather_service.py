"""
NASA Weather Data Service
Adapted from codes/main.py for Flask backend integration
"""
...
def get_point_data_for_period(latitude, longitude, start_date_str, end_date_str, progress_callback=None):
    """
    Tek nokta için tarih aralığındaki hava durumu verilerini toplar
    """
    ...
    for single_date in daterange(start_date, end_date):
        ...
        coordinates_list.append((latitude, longitude, date_str))
...
def create_weather_charts(data, output_dir="static/charts"):
    """Hava durumu verilerini grafikleştirir ve base64 döndürür"""
    ...
    return {
        'weather_chart': img_base64,
        'statistics_chart': stats_base64
    }